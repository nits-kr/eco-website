                            ...
                            <div className="col-12 design_outter_comman shadow">
                                <div className="row comman_header justify-content-between">
                                    ...
                                    <div className="col-auto Searchbox">
                                        <button className="comman_btn2"><i className="fal fa-download me-2"></i>Excel</button>
                                    </div>
                                                    ...
                                                    <div className="col-12">
                                                                    ...
                                                                    <table className="table mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>10%</td>
                                                                                <td>
                                                                                    <Link className="comman_btn2 table_viewbtn"
                                                                                        to="/transactionDetails">View</Link>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>2</td>
                                                        ...
                                                        <div className="row Total_amt mx-0 my-3 py-3">
                                                            ...
                                                            <div className="col-6 text-start">
                                                                <span className="fw-bold fs-6 text-white table_viewbtn bg-dark ">2000 SAR</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="row mx-0">
                                                    <div className="col-12">
                                                        ...
                                                        <div className="row Total_amt mx-0 my-3 py-3">
                                                            ...
                                                            <div className="col-6 text-start">
                                                                <span className="fw-bold fs-6 text-white table_viewbtn bg-dark ">500 SAR</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
