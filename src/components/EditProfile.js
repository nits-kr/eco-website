...
function EditProfile() {
    ...
    const handleOnSave = () => {
        ...
        data.append("userName", "ajay");
        data.append("userEmail", "ajay23@gmail.com");
        ...
        axios
            ...
            .then((response) => {
                ...
                Swal.fire({
                    title: "OTP sent!",
                    text: "Your OTP has been sent at your registered email successfully.",
                    icon: "success",
                            ...
                            >
                                ...
                                <div className="form-group col-12 text-center">
                                    <label className="text-center" htmlFor="">
                                        Didn't received the OTP? <Link to="/varification">Request again</Link>
                                    </label>
                                </div>
