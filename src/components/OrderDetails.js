                                                            ...
                                                            <div className="row mx-0">
                                                                ...
                                                                <div className="col-md-6">
                                                                    ...
                                                                    <div className="row justify-content-center">
                                                                        ...
                                                                        <div className="col-12 users_left_content text-center">
                                                                            <Link to="user-details.html"><strong>Ram Jain</strong></Link>
                                                                            <div className="rating_box">
                                                                                <Link to=""><i className="fas fa-star"></i></Link>
                                                                                <Link to=""><i className="fas fa-star"></i></Link>
                                                                                <Link to=""><i className="fas fa-star"></i></Link>
                                                        ...
                                                        <div className="row mx-0 p-4 product_location">
                                                            <div className="col-12">
                                                                <iframe
                                                                    ...
                                                                    loading="lazy" title="Google Maps - San Diego, California" referrerPolicy="no-referrer-when-downgrade"></iframe>
                                                            </div>
                                                        </div>
                                                    </div>
