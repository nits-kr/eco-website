                                                            ...
                                                            <div className="row mx-0">
                                                                <div className="col-md-6">
                                                                    <div className="row justify-content-center">
                                                                        ...
                                                                        <div className="col-12 users_left_content text-center">
                                                                            <Link to="/userDetails"><strong>Ajay Sharma</strong></Link>
                                                                ...
                                                                <div className="col-md-6">
                                                                    <div className="row justify-content-center">
                                                                        ...
                                                                        <div className="col-12 users_left_content text-center">
                                                                            <Link to="/userDetails"><strong>Ram Jain</strong></Link>
                                                                            <div className="rating_box">
                                                                                <Link to=""><i className="fas fa-star"></i></Link>
                                                                                <Link to=""><i className="fas fa-star"></i></Link>
                                                                                <Link to=""><i className="fas fa-star"></i></Link>
                                                                ...
                                                                <div className="col-12 offerdetails_inner border">
                                                                    <div className="row">
                                                                        ...
                                                                        <div className="col-md-6">
                                                                            ...
                                                                            <span><i className="fal fa-calendar-alt me-2"></i> Order Date</span>
                                                                        </div>
                                                                        <div className="col-md-6">
                                                                            <span><i className="fal fa-edit me-2"></i> Order ID</span>
                                                                            <span><i className="fal fa-sack-dollar me-2"></i> Price</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="row mx-0 p-4 product_location">
                                                            <div className="col-12">
                                                                <iframe
                                                                    ...
                                                                    loading="lazy" title="Google Map of San Diego, California, USA" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                                            </div>
                                                        </div>
                                                    </div>
